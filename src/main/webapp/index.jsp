...
<FORM ACTION="login.jsp" METHOD="post">
    ...
    <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="emailCheck" value="2" required> Login by Email
    ...
    <br>
    <h5 style="color: darkred">The user account is currently locked. Please contact your exam coordinator.</h5>
</FORM>
</div>
</BODY>
</HTML>
